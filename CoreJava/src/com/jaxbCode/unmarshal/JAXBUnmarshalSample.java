package com.jaxbCode.unmarshal;
...
import com.jaxbCode.bean.Animals.Animal;
...
public class JAXBUnmarshalSample {
	...
	public static void main(String[] args) {
		try {
			...
			JAXBContext jaxbContext = JAXBContext.newInstance("com.jaxbCode.bean");
			Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
			JAXBElement zoo = (JAXBElement) unmarshaller.unmarshal(new FileInputStream("C:\\Sachin\\personnel\\JAXB\\zoo.xml"));
